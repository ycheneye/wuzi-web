...
<jsp:include page="public/top.jsp"></jsp:include>
	...
	<div id="tb">
		<div>
			...
			&nbsp;报损物资名称：&nbsp;<input type="text" name="goodsName_search" id="goodsName_search" size="20" onkeydown="if(event.keyCode==13) search()"/>
			<a href="javascript:search()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
		</div>
	</div>


	<table id="grid0" title="报损查询" class="easyui-datagrid" fitColumns="true" pageSize="20"
	    pagination="true" singleSelect="true" rownumbers="true" url="${basePath}/admin/dept/listBscx.do" fit="true" toolbar="#tb">
	    <thead>
	    	<tr>
	    		...
	    		<th field="count" width="50" align="center">报损数量</th>
