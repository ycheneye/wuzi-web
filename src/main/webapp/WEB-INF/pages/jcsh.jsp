...
<jsp:include page="public/top.jsp"></jsp:include>
	...
	<table id="grid0" title="借用查询" class="easyui-datagrid" fitColumns="true" pageSize="20"
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th field="op" width="150" align="center" formatter = "auditOp">管理员操作</th>
	...
	<script>
		...
		function audit(id,goodsid,count){
			if(grid0.getSelections()[0].state == 4){
				$.messager.alert('系统提示','<font color=red>已经审核通过，请勿重复审核！</font>');
				return;
				
			}
			
			$.post("${basePath}/admin/dept/audit.do",{id:id,goodsid:goodsid,count:count },function(data){
				if(data.errCode < 0){
