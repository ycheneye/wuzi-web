...
<jsp:include page="public/top.jsp"></jsp:include>
	...
	<div id="tb">
		<div>
			...
			&nbsp;入库物资名称：&nbsp;<input type="text" name="goodsName_search" id="goodsName_search" size="20" onkeydown="if(event.keyCode==13) search()"/>
			<a href="javascript:search()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
		</div>
	</div>


	<table id="grid0" title="入库查询" class="easyui-datagrid" fitColumns="true" pageSize="20"
