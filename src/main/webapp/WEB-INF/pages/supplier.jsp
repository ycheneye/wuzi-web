...
<jsp:include page="public/top.jsp"></jsp:include>
	...
	<table id="grid0" title="供应商管理" class="easyui-datagrid" fitColumns="true" pageSize="20"
	    pagination="true" singleSelect="true" rownumbers="true" url="${basePath}/admin/supplier/list.do" fit="true" toolbar="#tb">
	    <thead>
	    	<tr>
	    		<th field="cb" checkbox="true" align="center"></th>
	    		<th field="supplier_name" width="100" align="center">供应商名称</th>
	    		<th field="addr" width="100" align="center">地址</th>
	    		<th field="tel" width="100" align="center">联系方式</th>
	...
	<div id="tb">
		...
		<div>
			&nbsp;供应商名称：&nbsp;<input type="text" name="supplier_name_search" id="supplier_name_search" size="20" onkeydown="if(event.keyCode==13) search()"/>
	...
	<!-- 供应商新增、修改页面 -->
	<div id="dialog0" class="easyui-dialog" style="width: 420px;height: 250px;padding: 10px 20px"
	  closed="true" buttons="#dlg-buttons">
	  <form id="form0" method="post">
	  	<table cellspacing="5px;">
	  		<tr>
	  			<td>供应商名称：</td>
	  			<td><input type="text" id="supplier_name" name="supplier_name" class="easyui-validatebox" required="true"/></td>
	  		</tr>
	  		<tr>
	  			<td>供应商地址：</td>
	  			<td><input type="text" id="addr" name="addr" class="easyui-validatebox" required="true"/></td>
	  		</tr>
	  		<tr>
	  			<td>供应商联系方式：</td>
	...
	<script>
		...
		function openAddDialog(){
			url = "${basePath}/admin/supplier/save.do";
			dialog0.open("添加供应商信息");
		}
		...
		function openModifyDialog(){
			...
			url = "${basePath}/admin/supplier/save.do?id=" + row.id;
			
			dialog0.open("修改供应商信息");
		...
		function search(){
			...
			var obj = {};
			obj.goodsName = "%"+supplier_name_search+"%";
			grid0.reload(obj);
		}
		...
		function deleteDatas(){
			...
			$.messager.confirm("系统提示","<font style='color:red;text-align:center;'>您确认要删除这条数据吗？</font>",function(r){
				...
				//需要把这个id传递到后台
				$.post("${basePath}/admin/supplier/delete.do",{id:id},function(data){
					//console.log(data);
					if(data.errCode < 0){
