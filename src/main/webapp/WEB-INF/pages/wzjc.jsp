...
<jsp:include page="public/top.jsp"></jsp:include>
	...
	<div id="cc" class="easyui-layout" style="width:100%;height:400px;">
	    <div data-options="region:'east',title:'借出',split:true" style="width:400px;">
	...
	<a style="float:right;" onclick="ly()" class="css-3d-btn">借出</a>
	...
	<script>
		...
		function ly(){
			...
			if(!grid1.getSelectedCount()){
				$.messager.alert('系统提示','<font color=red>请选择要借出的物资！</font>');
				return;
			}
			...
			var count = parseInt(prompt("请填写借出数量！"));
			if(!checknum(count)){
			...
			$.post("${basePath}/admin/dept/jc.do",obj,function(data){
				...
				$.messager.alert('系统提示','<font color=green>已提交审核！</font>');
